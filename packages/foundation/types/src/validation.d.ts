 ...
 */
export type ValidationRuleType = 'field' | 'cross_field' | 'business_rule' | 'state_machine' | 'unique' | 'dependency' | 'custom';
/**
 ...
 */
export type ValidationOperator = '=' | '!=' | '>' | '>=' | '<' | '<=' | 'in' | 'not_in' | 'contains' | 'not_contains' | 'starts_with' | 'ends_with';
/**
 ...
 */
export type AnyValidationRule = ValidationRule | CrossFieldValidationRule | BusinessRuleValidationRule | StateMachineValidationRule | UniquenessValidationRule | DependencyValidationRule | CustomValidationRule;
/**
