...
export class SwaggerUIPlugin implements RuntimePlugin {
    ...
    private async startPlugin(ctx: any): Promise<void> {
        ...
        console.log(`[${this.name}] ⚠️  No shared HTTP server found. Swagger UI requires an HTTP server to function.`);
    ...
    private attachToHono(app: any): void {
        ...
        try {
            ...
            console.log(`[${this.name}] 📚 Swagger UI available at ${basePath}`);
            console.log(`[${this.name}] 📄 OpenAPI spec will be loaded from ${specUrl}`);
