...
This is a workspace stub package created during the ObjectQL type system cleanup phase. The real `@objectql/runtime` package will be published separately to npm.
