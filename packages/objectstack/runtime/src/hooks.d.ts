 ...
 */
export type HookName = 'beforeFind' | 'afterFind' | 'beforeCount' | 'afterCount' | 'beforeCreate' | 'afterCreate' | 'beforeUpdate' | 'afterUpdate' | 'beforeDelete' | 'afterDelete' | 'beforeValidate' | 'afterValidate';
/**
...
export declare class HookManager {
     ...
     * Register a hook
     */
    register(event: HookName, objectName: string, handler: HookHandler, packageName?: string): void;
    /**
     * Trigger hooks for an event
     */
    trigger(event: HookName, objectName: string, ctx: HookContext): Promise<void>;
    /**
