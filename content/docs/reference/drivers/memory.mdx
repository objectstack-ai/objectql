...
**For persistent browser storage**, use the [LocalStorage Driver](/docs/reference/drivers/localstorage).
...
- [LocalStorage Driver](/docs/reference/drivers/localstorage) - For persistent browser storage
