...
fields:
  ...
  status:
    ...
    ai_context:
      ...
      # State machine information for AI understanding
      # Note: For actual state transition enforcement, define a state_machine
      # validation rule in project.validation.yml (see Validation spec)
