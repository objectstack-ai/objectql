---
title: "ObjectQL Metadata Standard - Complete Guide"
description: ObjectQL Metadata Standard - Complete Guide
---
## Introduction
...
#### [Validation Rules](./validation.mdx)
...
#### [Workflows & Processes](./workflow.mdx)
...
1. **Start Simple**: Define your first object → [Objects & Fields](./object.mdx)
...
### Core Data Layer
- [Objects & Fields](./object.mdx) - Data modeling
- [Query Language](./query-language.mdx) - Data access
- [Validation](./validation.mdx) - Data quality
- [Formula Fields](./formula.mdx) - Calculated fields
- [Initial Data](./data.mdx) - Seed data

### Business Logic Layer
- [Hooks](./hook.mdx) - Event triggers
- [Actions](./action.mdx) - Custom operations
- [Workflows](./workflow.mdx) - Process automation

### User Interface Layer
- [Pages](./page.mdx) - UI pages and components
- [Views](./view.mdx) - Data presentation
- [Forms](./form.mdx) - Data entry
- [Reports](./report.mdx) - Analytics
- [Menus](./menu.mdx) - Navigation

### Application & Security
- [Apps](./app.mdx) - Application organization
- [Permissions](./permission.mdx) - Security and access control