---
title: "Validation Rule Metadata"
...
rules:
  ...
  # This enforces valid state transitions at the validation layer.
  # For AI-friendly documentation of states, also add is_state_machine: true
  # in the field's ai_context (see Object spec).
