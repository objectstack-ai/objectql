---
title: "Attachment API Specification"
description: Attachment API Specification
---
**Version:** 1.0.0
...
- [Object Definition Specification](/docs/modeling) - Field type definitions
- [API Reference](/docs/reference) - Complete API documentation
- [Validation Rules](/docs/logic) - File validation configuration
- [Server Integration](/docs/server/integration) - Setting up file storage
