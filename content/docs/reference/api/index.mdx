...
| **GraphQL** | Modern frontends with complex data requirements, real-time subscriptions | `POST /api/graphql` | [Read Guide](./graphql.md) |
| **OData V4** | Enterprise applications, standardized queries with $filter/$expand | `/odata/:entity` | [Read Guide](./odata-v4.md) |
