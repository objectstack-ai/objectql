...
- [`@objectql/plugin-security` README](/docs/server/security)
...
- [Security Plugin Source](https://github.com/objectstack-ai/objectql/tree/main/packages/foundation/plugin-security) - Plugin source code and README
