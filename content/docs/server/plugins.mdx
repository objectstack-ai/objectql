...
ObjectQL provides official plugins for common use cases:

### @objectql/plugin-security

Comprehensive security plugin with RBAC, Field-Level Security (FLS), and Row-Level Security (RLS).
...
- ✅ Row-Level Security (RLS) with AST-level filtering
- ✅ Field-Level Security (FLS) with field masking
- ✅ Pre-compiled permissions (O(1) lookups)
...
**Documentation:**
- [Security Plugin README](https://github.com/objectstack-ai/objectql/tree/main/packages/foundation/plugin-security)
- [Architecture Documentation](https://github.com/objectstack-ai/objectql/blob/main/packages/foundation/plugin-security/ARCHITECTURE.md)
- [Security Guide](/docs/server/security)
