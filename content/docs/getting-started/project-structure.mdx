---
title: "Organizing Metadata for Large Projects"
description: Organizing Metadata for Large Projects
---
...
- [Data Modeling Guide](/docs/modeling)
- [Plugin Development](/docs/extending/plugins)
- [Logic Hooks](/docs/logic/hooks)
