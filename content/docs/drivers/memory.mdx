---
title: Memory Driver
description: High-performance in-memory driver powered by Mingo for testing, development, and edge environments
---
...
**For persistent browser storage**, use the [LocalStorage Driver](/docs/drivers/localstorage).
...
- [LocalStorage Driver](/docs/drivers/localstorage) - For persistent browser storage
- [SQL Driver](/docs/drivers/sql) - For production databases
- [Testing Guide](/docs/extending/protocol-tck)

## Support

- 📖 [Mingo Documentation](https://github.com/kofrasa/mingo)
