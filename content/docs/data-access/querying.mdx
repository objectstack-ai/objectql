...
> Check out the [Query Best Practices Guide](/docs/data-access/best-practices) for a comprehensive guide on choosing the right approach (JSON-DSL, REST, GraphQL) and performance optimization techniques.
...
console.log(id); // Returns just the ID string
```
